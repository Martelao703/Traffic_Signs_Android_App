public class TriangleAreaOperator implements IGeoOperator {
    ...
    public boolean isInsideZone(GPSCoordinate point, PolygonalLine line, double maxOffSet){
        ...
        if (triangleArea == 0) {
            /*PolygonalLine line2 = new PolygonalLine(new DeltaPosition(39.733745, -8.805327), new DeltaPosition(39.733974, -8.804694));
            IVIMSegmentGeoRectangle rectangle2 = new IVIMSegmentGeoRectangle();
